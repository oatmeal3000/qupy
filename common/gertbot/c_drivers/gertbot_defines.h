...
#define CMD_ENDSTOP    0x02 // <ID> <stopmask> 
...
#define CMD_UNUSED1B   0x1B // -
#define CMD_UNUSED1C   0x1C // -
#define CMD_UNUSED1D   0x1D // -
...
#define MOT_MODE_STEP_STOP   0x10 // Flag to stop stepper when done 
...
#define CMD_CL17 1
#define CMD_CL18 1
#define CMD_CL19 7 // 19 <id> <format> <d0> <d1> <d2> <d3> <d4>
#define CMD_CL1A 0  // 5 1A <id> <repeat> <preamble> <dc_ms> <dc_ls>
#define CMD_CL1B 0
#define CMD_CL1C 0
#define CMD_CL1D 0
#define CMD_CL1E 0
